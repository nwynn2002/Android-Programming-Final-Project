...
public class BookSearchFeed extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_book_search_feed, container, false);
        SearchBar m = (SearchBar) getActivity();

        LinearLayout book_layout = view.findViewById(R.id.general_book_feed);
        ...
        ArrayList<ArrayList<String>> book_info = MainActivity.BOOK_DB.getTitleAuthor();
